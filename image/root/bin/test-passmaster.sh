...
docker-image-build-fedora --title pass --package-name pass --entrypoint pass --command &&
    ...
    docker-container-create --interactive --tty --rm --title pass --image pass &&
    docker-container-create --interactive --tty --rm --title gpgme --image gpgme &&
    docker-container-create --interactive --tty --rm --title findutils --image findutils &&
